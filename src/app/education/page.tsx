      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 max-w-4xl mx-auto">
            {[
              { icon: Shield, value: '법원 인정', label: '공인 수료증' },
              ...
              <div
                key={stat.label}
                className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 md:p-5 text-center hover:bg-white/15 transition-all"
              >
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 relative overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              { icon: Shield, title: '법원·검찰 인정', desc: '공인 수료증 발급', gradient: 'from-blue-500 to-blue-600' },
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-secondary-600 to-secondary-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  href="tel:1544-0000"
                  className="inline-flex items-center gap-2 bg-white text-secondary-900 px-8 py-4 rounded-xl font-semibold hover:bg-secondary-50 transition-colors shadow-lg"
                >
                  <Phone className="w-5 h-5" />
                  1544-0000
                </a>
